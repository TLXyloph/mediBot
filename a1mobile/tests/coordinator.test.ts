...
const environment: Environment = {
  ...
  a1mobileApiBaseUrl: undefined,
  a1mobileApiKey: undefined,
  a1mobileAgentId: undefined,
  a1mobileCallPath: "/v1/calls",
  a1mobileMessagePath: "/v1/messages",
  a1mobileWebhookSecret: undefined,
